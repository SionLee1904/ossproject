...
const MAIN_DECK_CARDS = [
    { 
      id: 42790071, 
      card_images: [{ image_url: "https://images.ygoprodeck.com/images/cards/42790071.jpg" }],
      quantity: 2
    },
    { 
      id: 27541563, 
      card_images: [{ image_url: "https://images.ygoprodeck.com/images/cards/27541563.jpg" }],
      quantity: 3
    },
];
...
const EXTRA_DECK_CARDS = [
    { 
      id: 1508649,
      card_images: [{ image_url: "https://images.ygoprodeck.com/images/cards/1508649.jpg" }],
      quantity: 2
    },
];
...
export default function AltergeistPage() {
    ...
    return (
        <div style={{ padding: "16px", maxWidth: "1200px", margin: "0 auto" }}>
            ...
            <p>대략적인 덱 설명 (이미지 클릭시, 세부 정보 표시)</p>
